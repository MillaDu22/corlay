...
import Logo from '../Logo2/index.jsx'
        ...
        <footer className="container-footer">
            ...
            <div className="box-links-footer">
                <div className="txt-footer">
                    < Logo />
                    <p className="adress">22 320 Corlay - Bretagne - FRANCE</p>
                    <p className="copyright">©Commune-de-Corlay-2025, tous droits réservés</p>
                </div>
                <div className="container-reseaux">
                    <h2 className= "title-reseaux">Suivez Corlay :</h2>
