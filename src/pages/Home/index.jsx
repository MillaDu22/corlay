...
import Blason from '../../assets/images/accueil/Blason.webp';
        ...
        <div className="container-home">
            <div className="home" ref={pageRef}>
                <React.Fragment>
                    <Helmet>
                        {/* Meta Tags */}
                        <title>Commune de Corlay - Patrimoine et Vie Locale en Côtes d'Armor</title>
                        ...
                        <link rel="canonical" href="https://commune-de-corlay.vercel.app" />
                        <meta name="keywords" content="Corlay, Côtes d'Armor, Bretagne, patrimoine breton, tourisme en Bretagne, vie locale Corlay, cheval breton, haras national, château de Corlay, événements locaux Corlay, nature et randonnées, communes bretonnes, culture bretonne, activités en famille, sites historiques Bretagne, dynamisme rural, marché local Corlay, associations Corlay, vivre en Bretagne, tourisme rural, communes des Côtes d'Armor, campagne bretonne, découvertes en Bretagne, traditions bretonnes, fêtes locales Corlay, hébergement Corlay, restaurants locaux, tourisme durable, environnement préservé" />

                        {/* Open Graph tags for Social Media sharing */}
                        <meta property="og:title" content="Commune de Corlay - Découvrez l'authenticité bretonne" />
                        <meta property="og:description" content="Explorez la commune de Corlay en Côtes d'Armor, connue pour son patrimoine historique, ses paysages naturels et son dynamisme culturel. Idéal pour les amoureux de la Bretagne." />
                        <meta property="og:image" content="https://commune-de-corlay.vercel.app/homepage.jpg" />
                        <meta property="og:url" content="https://commune-de-corlay.vercel.app" />
                        ...
                        <meta name="twitter:title" content="Commune de Corlay - Bretagne et Patrimoine" />
                        <meta name="twitter:description" content="Découvrez la commune de Corlay, un trésor caché des Côtes d'Armor, avec son histoire, ses activités locales et son cadre naturel exceptionnel." />
                        <meta name="twitter:image" content="https://commune-de-corlay.vercel.app/homepage.jpg" />
                    </Helmet>
                    ...
                    <div className= "intro-quadra1">
                        <div className="box-title-intro">
                            <div className="typewriter">
                                <h1 className="title1">Commune de Corlay</h1>
                            </div>
                            <img className="blason" src={Blason} alt="blason de Corlay" />
                                <h2 className="title2">Bienvenue à Corlay, au cœur de la Bretagne authentique !</h2>
                                <p>C’est avec un immense plaisir que nous vous accueillons sur le site officiel de la commune de Corlay, 
                                ...
                                <p>
                                    Corlay est fière de son passé, marqué par son rôle central dans l’élevage de chevaux, 
